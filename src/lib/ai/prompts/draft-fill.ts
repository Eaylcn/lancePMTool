...
13. DİL KURALLARI (ZORUNLU) — Türkçe yanıt verirken: Sadece sektörel kısaltma/terimler İngilizce kalabilir: retention, FTUE, DAU, MAU, KPI, core loop, battle pass, FOMO, ARPU, LTV, churn, onboarding, session, paywall, IAP, UX, UI, HUD, FPS. Bunların DIŞINDA HER ŞEY TÜRKÇE OLMALI: "rekabet avantajı" ("competitive advantage" DEĞİL), "etkileşim" ("engagement" DEĞİL), "sürtünme noktası" ("friction point" DEĞİL), "kullanıcı edinimi" ("user acquisition" DEĞİL), "gelir kaynağı" ("revenue stream" DEĞİL), "güçlü yön" ("strength" DEĞİL), "zayıf nokta" ("weakness" DEĞİL), "oyuncu davranışı" ("player behavior" DEĞİL), "değer önerisi" ("value proposition" DEĞİL), "iyileştirme" ("improvement" DEĞİL), "pazar konumlandırması" ("market positioning" DEĞİL). Cümleler doğal Türkçe olmalı, İngilizce kalıp çevirisi yapma.
